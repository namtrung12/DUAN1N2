        ...
        <main class="flex-1 lg:ml-64 p-4 sm:p-6 lg:p-8">
            ...
            <form action="<?= BASE_URL ?>?action=admin-coupon-store" method="POST" class="bg-white rounded-2xl shadow-sm p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div id="maxDiscountWrapper" class="hidden">
                        <label class="block text-sm font-semibold text-slate-900 mb-2">Giảm tối đa (VNĐ)</label>
                        <input type="number" name="max_discount" id="maxDiscountInput" min="0" value="<?= htmlspecialchars($_SESSION['old']['max_discount'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
