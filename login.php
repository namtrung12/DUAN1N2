...
<head>
    ...
    <title>Dang nhap - Chill Drink</title>
...
<body class="bg-gray-50">
    ...
    <main class="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="max-w-md mx-auto bg-white rounded-2xl p-8 shadow-sm">
            <h1 class="text-2xl font-bold text-slate-900 mb-4">Dang nhap</h1>
            ...
            <form action="<?= BASE_URL ?>?action=login" method="POST" class="space-y-4">
                <div>
                ...
                <button class="w-full px-4 py-2 bg-primary text-white rounded-lg font-semibold">Dang nhap</button>
            </form>

            <div class="mt-4 text-sm text-slate-500">
                <p>Admin: admin@chilldrink.vn / admin123</p>
                <p>Customer: user@chilldrink.vn / 123456</p>
            </div>
        </div>
    </main>
