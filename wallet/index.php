...
<body class="font-display">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch justify-between gap-6 rounded-lg bg-white p-6 shadow-sm">
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex gap-3">
                                    <a href="<?= BASE_URL ?>?action=wallet-deposit" class="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-text-main-light gap-2 text-sm font-semibold leading-normal hover:bg-primary/90 transition-colors">
                                        <span class="material-symbols-outlined text-lg">account_balance_wallet</span>
                                        <span class="truncate">Nạp tiền</span>
                                    </a>
                                    <button onclick="showWithdrawNotification()" class="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-orange-500 text-white gap-2 text-sm font-semibold leading-normal hover:bg-orange-600 transition-colors">
                                        <span class="material-symbols-outlined text-lg">payments</span>
                                        <span class="truncate">Rút tiền</span>
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        function showWithdrawNotification() {
            alert('Tính năng rút tiền đang được phát triển. Vui lòng quay lại sau!');
        }
    </script>
</body>
