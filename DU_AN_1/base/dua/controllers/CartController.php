...
class CartController
{
    ...
    public function applyCoupon()
    {
        ...
        // Kiểm tra nếu là mã đổi điểm (is_redeemable = 1) thì chỉ dùng được 1 lần
        if ($coupon['is_redeemable'] && $this->couponModel->hasUserUsedCoupon($_SESSION['user']['id'], $coupon['id'])) {
