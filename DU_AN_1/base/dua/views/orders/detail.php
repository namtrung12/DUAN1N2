                                        ...
                                        <div class="flex gap-4 pb-4 border-b last:border-b-0">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <?php if ($order['status'] === 'completed'): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <button onclick="openReviewModal(<?= $order['id'] ?>, <?= $item['product_id'] ?>, '<?= htmlspecialchars($item['product_name'], ENT_QUOTES, 'UTF-8') ?>')" class="mt-2 text-sm text-primary hover:text-primary/80 font-semibold flex items-center gap-1">
            ...
            <form id="reviewForm" method="POST" action="<?= BASE_URL ?>?action=order-review">
                ...
                <div class="mb-4">
                    ...
                    <div class="flex gap-2 text-3xl">
                        <span class="star cursor-pointer hover:text-yellow-400" data-rating="1">☆</span>
                        <span class="star cursor-pointer hover:text-yellow-400" data-rating="2">☆</span>
                        <span class="star cursor-pointer hover:text-yellow-400" data-rating="3">☆</span>
                        <span class="star cursor-pointer hover:text-yellow-400" data-rating="4">☆</span>
                        <span class="star cursor-pointer hover:text-yellow-400" data-rating="5">☆</span>
                    </div>
                </div>
