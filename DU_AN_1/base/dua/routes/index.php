...
match ($action) {
    ...
    'staff'                           => (new StaffController)->index(),
    'staff-orders'                    => (new StaffController)->orders(),
    'staff-update-order'              => (new StaffController)->updateOrder(),
    'staff-order-update-status'       => (new StaffController)->updateOrderStatus(),
