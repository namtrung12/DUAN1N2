                            ...
                            <div class="bg-white rounded-xl shadow-sm p-6 md:p-8">
                                ...
                                <?php if (empty($addresses)): ?>
                                    <div class="text-center py-6">
                                        ...
                                        <a href="<?= BASE_URL ?>?action=address-create&return_url=checkout" class="inline-flex items-center justify-center h-10 px-4 bg-primary text-white rounded-lg font-semibold hover:bg-opacity-90">Thêm địa chỉ</a>
                                    </div>
                                <?php else: ?>
                                    <div class="space-y-4">
                                    ...
                                    <a href="<?= BASE_URL ?>?action=address-create&return_url=checkout" class="inline-flex items-center justify-center mt-4 h-10 px-4 bg-gray-200 text-custom-text rounded-lg font-semibold hover:bg-gray-300">+ Thêm địa chỉ mới</a>
                                <?php endif; ?>
                            </div>
