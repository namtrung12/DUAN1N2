                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <?php if ($coupon['required_rank']): ?>
                                        ...
                                        ?>
                                        <span class="px-2 py-0.5 <?= $rankColors[$coupon['required_rank']] ?> rounded text-[10px] font-semibold whitespace-nowrap">
                                            <?= $rankNames[$coupon['required_rank']] ?>
                                        </span>
                                    <?php else: ?>
                                        <span class="text-gray-400 text-xs">Tất cả</span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <?php if ($coupon['status']): ?>
                                        <span class="px-2 py-0.5 bg-green-100 text-green-700 rounded text-[10px] font-semibold whitespace-nowrap">Hoạt động</span>
                                    <?php else: ?>
                                        <span class="px-2 py-0.5 bg-gray-100 text-gray-700 rounded text-[10px] font-semibold whitespace-nowrap">Tắt</span>
                                    <?php endif; ?>
                                </td>
                                <td class="px-6 py-4">
